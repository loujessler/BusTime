...
def make_keyboard(user, minutes, seconds):
    ...
    keyboard.row(
        ...
        InlineKeyboardButton(f"{minutes} {msg.get_message({'minutes': 'none'}, None, 0)}",
    ...
    keyboard.row(
        ...
        InlineKeyboardButton(f"{seconds} {msg.get_message({'seconds': 'none'}, None, 0)}",
                             callback_data=f"nothing"),
        InlineKeyboardButton('>', callback_data=f"inc_seconds:{minutes}:{seconds}"),
    )
    keyboard.row(
        InlineKeyboardButton(msg.get_message({'set_notification': 'none'}, None, 0),
